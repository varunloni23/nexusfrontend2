...
import LookerStudio from '../components/LookerStudio';

const menuItems = [
  { id: 'looker-studio', label: 'Looker Studio', icon: SmartToy, color: '#00E5FF' },
  ...
  { id: 'reports', label: 'Reports', icon: Timeline, color: '#81C784' },
...
export default function FuturisticDashboard() {
  ...
  const handleNavClick = (itemId: string) => {
    ...
    switch (itemId) {
      ...
      case 'quality-consistency':
        ...
        break;
      case 'reports':
        console.log('Showing Reports view - report generation and analytics');
        break;
      case 'ai-assistant':
  ...
  const renderActiveViewContent = () => {
    if (activeView === 'quality-consistency') {
      ...
      // Return dedicated Reports Generator
      return <ReportGenerator dashboardData={dashboardData || undefined} />;
    } else if (activeView === 'looker-studio') {
      // Return Looker Studio View with AI Assistant
      return (
        <LookerStudio />
      );
              ...
              <Paper sx={{ 
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, height: 'calc(100% - 50px)' }}>
                  ...
                  <Alert severity="warning" sx={{ backgroundColor: 'rgba(255, 152, 0, 0.1)', border: '1px solid rgba(255, 152, 0, 0.3)' }}>
                    <Typography variant="body2" sx={{ wordBreak: 'break-word', lineHeight: 1.4 }}>
                      ⚡ <strong>Energy Alert:</strong> Energy consumption at {plant_overview.energy_consumption_current.toFixed(1)} kWh/t. Recommend adjusting {(current_parameters?.kiln_temperature || 0) > 1460 ? 'kiln temperature down' : 'mill speed up'} for 3% savings
                    </Typography>
                  </Alert>
                </Box>
              </Paper>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                  <Box>
                    ...
                    <Typography variant="h6" sx={{ color: '#FFB74D', fontWeight: 700 }}>
                      {current_parameters?.kiln_temperature?.toFixed(0) || '0'}°C
                    </Typography>
                  </Box>
                  <Box>
                    ...
                    <Typography variant="h6" sx={{ color: '#40C4FF', fontWeight: 700 }}>
                      {current_parameters?.raw_mill_power?.toFixed(0) || '0'} kW
                    </Typography>
                  </Box>
                  <Box>
                    <Typography variant="body2" sx={{ color: '#A0AEC0', fontSize: '0.75rem' }}>Cement Mill Power</Typography>
                    <Typography variant="h6" sx={{ color: '#40C4FF', fontWeight: 700 }}>
                      {current_parameters?.cement_mill_power?.toFixed(0) || '0'} kW
                    </Typography>
                  </Box>
                  <Box>
                    ...
                    <Typography variant="h6" sx={{ color: '#81C784', fontWeight: 700 }}>
                      {current_parameters?.alternative_fuel_rate?.toFixed(1) || '0.0'}%
                    </Typography>
                  </Box>
                  <Box>
                    ...
                    <Typography variant="h6" sx={{ color: '#E0E6ED', fontWeight: 700 }}>
                      {current_parameters?.raw_mill_flow?.toFixed(1) || '0.0'} TPH
                    </Typography>
                  </Box>
                  <Box>
                    ...
                    <Typography variant="h6" sx={{ color: '#BA68C8', fontWeight: 700 }}>
                      {current_parameters?.exhaust_fan_speed?.toFixed(0) || '0'} RPM
                    </Typography>
                  </Box>
                </Box>
              </Paper>
              ...
              >
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 2, height: 'calc(100% - 80px)' }}>
                  ...
                  <Box sx={{ 
                    p: 2, 
                    borderRadius: 2, 
                    background: (current_parameters?.kiln_temperature || 0) > 1470 || (current_parameters?.kiln_temperature || 0) < 1430 
                      ? 'linear-gradient(135deg, rgba(244, 67, 54, 0.2), rgba(255, 152, 0, 0.1))'
                      : 'linear-gradient(135deg, rgba(76, 175, 80, 0.2), rgba(129, 199, 132, 0.1))',
                    border: (current_parameters?.kiln_temperature || 0) > 1470 || (current_parameters?.kiln_temperature || 0) < 1430 
                    ...
                    <Typography variant="h6" sx={{ 
                      color: (current_parameters?.kiln_temperature || 0) > 1470 || (current_parameters?.kiln_temperature || 0) < 1430 ? '#F44336' : '#4CAF50',
                      fontWeight: 700,
                      fontSize: '1.2rem'
                    }}>
                      {current_parameters?.kiln_temperature?.toFixed(0) || '0'}°C
                    ...
                    <Typography variant="caption" sx={{ 
                      color: (current_parameters?.kiln_temperature || 0) > 1470 || (current_parameters?.kiln_temperature || 0) < 1430 ? '#FF5722' : '#81C784',
                      fontSize: '0.7rem'
                    }}>
                      {(current_parameters?.kiln_temperature || 0) > 1470 || (current_parameters?.kiln_temperature || 0) < 1430 ? 'Alert' : 'Stable'}
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ 
                    p: 2, 
                    borderRadius: 2, 
                    background: (current_parameters?.raw_mill_power || 0) > 3000 || (current_parameters?.raw_mill_power || 0) < 2700
                      ? 'linear-gradient(135deg, rgba(244, 67, 54, 0.2), rgba(255, 152, 0, 0.1))'
                      : 'linear-gradient(135deg, rgba(76, 175, 80, 0.2), rgba(129, 199, 132, 0.1))',
                    border: (current_parameters?.raw_mill_power || 0) > 3000 || (current_parameters?.raw_mill_power || 0) < 2700
                      ? '1px solid rgba(244, 67, 54, 0.4)' 
                      : '1px solid rgba(76, 175, 80, 0.4)',
                    textAlign: 'center'
                  }}>
                    ...
                    <Typography variant="h6" sx={{ 
                      color: (current_parameters?.raw_mill_power || 0) > 3000 || (current_parameters?.raw_mill_power || 0) < 2700 ? '#F44336' : '#4CAF50',
                      fontWeight: 700,
                      fontSize: '1.2rem'
                    }}>
                      {((current_parameters?.raw_mill_power || 0) / 1000).toFixed(1)}MW
                    </Typography>
                    <Typography variant="caption" sx={{ 
                      color: (current_parameters?.raw_mill_power || 0) > 3000 || (current_parameters?.raw_mill_power || 0) < 2700 ? '#FF5722' : '#81C784',
                      fontSize: '0.7rem'
                    }}>
                      {(current_parameters?.raw_mill_power || 0) > 3000 || (current_parameters?.raw_mill_power || 0) < 2700 ? 'Alert' : 'Stable'}
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ 
                    p: 2, 
                    borderRadius: 2, 
                    background: (current_parameters?.cement_mill_power || 0) > 3400 || (current_parameters?.cement_mill_power || 0) < 3000
                      ? 'linear-gradient(135deg, rgba(244, 67, 54, 0.2), rgba(255, 152, 0, 0.1))'
                      : 'linear-gradient(135deg, rgba(76, 175, 80, 0.2), rgba(129, 199, 132, 0.1))',
                    border: (current_parameters?.cement_mill_power || 0) > 3400 || (current_parameters?.cement_mill_power || 0) < 3000
                      ? '1px solid rgba(244, 67, 54, 0.4)' 
                      : '1px solid rgba(76, 175, 80, 0.4)',
                    textAlign: 'center'
                  }}>
                    ...
                    <Typography variant="h6" sx={{ 
                      color: (current_parameters?.cement_mill_power || 0) > 3400 || (current_parameters?.cement_mill_power || 0) < 3000 ? '#F44336' : '#4CAF50',
                      fontWeight: 700,
                      fontSize: '1.2rem'
                    }}>
                      {((current_parameters?.cement_mill_power || 0) / 1000).toFixed(1)}MW
                    </Typography>
                    <Typography variant="caption" sx={{ 
                      color: (current_parameters?.cement_mill_power || 0) > 3400 || (current_parameters?.cement_mill_power || 0) < 3000 ? '#FF5722' : '#81C784',
                      fontSize: '0.7rem'
                    }}>
                      {(current_parameters?.cement_mill_power || 0) > 3400 || (current_parameters?.cement_mill_power || 0) < 3000 ? 'Alert' : 'Stable'}
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ 
                    p: 2, 
                    borderRadius: 2, 
                    background: (current_parameters?.alternative_fuel_rate || 0) > 35 || (current_parameters?.alternative_fuel_rate || 0) < 15
                      ? 'linear-gradient(135deg, rgba(244, 67, 54, 0.2), rgba(255, 152, 0, 0.1))'
                      : 'linear-gradient(135deg, rgba(76, 175, 80, 0.2), rgba(129, 199, 132, 0.1))',
                    border: (current_parameters?.alternative_fuel_rate || 0) > 35 || (current_parameters?.alternative_fuel_rate || 0) < 15
                      ? '1px solid rgba(244, 67, 54, 0.4)' 
                      : '1px solid rgba(76, 175, 80, 0.4)',
                    textAlign: 'center'
                  }}>
                    ...
                    <Typography variant="h6" sx={{ 
                      color: (current_parameters?.alternative_fuel_rate || 0) > 35 || (current_parameters?.alternative_fuel_rate || 0) < 15 ? '#F44336' : '#4CAF50',
                      fontWeight: 700,
                      fontSize: '1.2rem'
                    }}>
                      {current_parameters?.alternative_fuel_rate?.toFixed(1) || '0.0'}%
                    ...
                    <Typography variant="caption" sx={{ 
                      color: (current_parameters?.alternative_fuel_rate || 0) > 35 || (current_parameters?.alternative_fuel_rate || 0) < 15 ? '#FF5722' : '#81C784',
                      fontSize: '0.7rem'
                    }}>
                      {(current_parameters?.alternative_fuel_rate || 0) > 35 || (current_parameters?.alternative_fuel_rate || 0) < 15 ? 'Alert' : 'Stable'}
                    </Typography>
                  </Box>
                </Box>
              </Paper>
  ...
  const getViewDescription = (viewId: string) => {
    const descriptions: Record<string, string> = {
      ...
      'reports': 'Generate comprehensive plant reports with charts and AI insights',
